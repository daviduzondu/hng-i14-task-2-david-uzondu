...
export const createNewProfile = async ({ age, name, country, gender, probability }: AgifyResponse & NationalizeResponse & GenderizeResponse) => await db.insertInto('profile').values({
 age: age,
 ...
 country_id: country.reduce((a, b) =>
  a.probability > b.probability ? a : b
 ).country_id,
 country_probability: Math.max(...country.map((c,) => c.probability)),
 gender: gender,
